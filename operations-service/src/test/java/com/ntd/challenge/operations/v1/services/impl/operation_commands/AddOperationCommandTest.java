...
public class AddOperationCommandTest {

    @Test
    void getOperationType_ShouldReturnAddition() {
        // Given
        BigDecimal value1 = new BigDecimal("10.5");
        BigDecimal value2 = new BigDecimal("5.5");
        AddOperationCommand command = new AddOperationCommand(value1, value2);

        // When
        OperationTypeEnum operationType = command.getOperationType();

        // Then
        assertEquals(OperationTypeEnum.ADDITION, operationType);
    }

    @Test
    void getOperationResult_ShouldReturnSumOfValues() {
        // Given
        BigDecimal value1 = new BigDecimal("10.5");
        BigDecimal value2 = new BigDecimal("5.5");
        AddOperationCommand command = new AddOperationCommand(value1, value2);
    ...
    void getOperationResult_ShouldHandleDecimalValues() {
        ...
        // Then
        assertEquals(new BigDecimal("15.579"), result);
    }
}
