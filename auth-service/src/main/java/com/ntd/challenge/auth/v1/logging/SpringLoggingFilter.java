...
import com.ntd.challenge.auth.v1.logging.wrappers.SpringRequestWrapper;
import com.ntd.challenge.auth.v1.logging.wrappers.SpringResponseWrapper;
...
public class SpringLoggingFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws ServletException, IOException {
        if (ignorePatterns != null && request.getRequestURI().matches(ignorePatterns)) {
            ...
            User user = AuthContextUtils.getLoggedUser();
